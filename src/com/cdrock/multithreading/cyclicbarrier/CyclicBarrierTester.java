package com.cdrock.multithreading.cyclicbarrier;

/**
 * @author Chandan Sharma
 * @link : https://www.geeksforgeeks.org/difference-between-countdownlatch-and-cyclicbarrier-in-java/
 */
...
class Computation2 implements Runnable {
    ...
    public void run()
    {
        ...
        System.out.println("Is the barrier broken? - "
                + CyclicBarrierTester.newBarrier.isBroken());
        sum = 10 + 20;
        try {
            CyclicBarrierTester.newBarrier.await(3000,
            ...
            System.out.println(
                    "Number of parties waiting at the barrier "
                            + "at this point = "
                            + CyclicBarrierTester.newBarrier.getNumberWaiting());
        }
        catch (InterruptedException
                | BrokenBarrierException e) {
            e.printStackTrace();
